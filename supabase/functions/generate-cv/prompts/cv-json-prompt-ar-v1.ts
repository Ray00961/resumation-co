export const CV_JSON_PROMPT_AR_V1 = `
...
### Bullet Count Realism Rule

لا يجب أن تحتوي جميع الوظائف على نفس عدد النقاط.

الوظائف الحديثة أو الأكثر ارتباطاً بالمسار المهني الحالي قد تحتوي على 4 إلى 6 نقاط.

الوظائف الأقدم أو الأقل صلة قد تحتوي على نقطة واحدة إلى 3 نقاط فقط.

يجب أن يبدو توزيع النقاط طبيعياً كما في السير الذاتية الحقيقية.

تجنّب النمط الآلي الذي يمنح جميع الوظائف نفس عدد النقاط.

### Bullet Structure Variation Rule

لا يجب أن تبدأ جميع النقاط بنفس النمط.

امزج بشكل طبيعي بين:

- نقاط تبدأ بفعل مهني.
- نقاط تبدأ بمسؤولية مباشرة.
- نقاط تبدأ بسياق العمل أو العملية.
- نقاط تبدأ بوصف نشاط يومي فعلي.

تجنّب تكرار نفس بداية الجملة عبر عدة نقاط متتالية.

يجب أن تبدو النقاط وكأنها كُتبت بشكل طبيعي من شخص حقيقي وليس من قالب ثابت.

### Responsibility Realism Rule

يجب أن تعكس المسؤوليات الحجم الحقيقي للدور الوظيفي.

لا تنسب للمرشح مسؤوليات استراتيجية أو قيادية أو تنفيذية ما لم تكن مدعومة بوضوح في البيانات المدخلة.

يجب أن يتناسب مستوى المسؤوليات مع المسمى الوظيفي والخبرة الفعلية للمرشح.

### Content Compression Rule

عندما يمتلك المرشح خبرة مهنية طويلة أو عدداً كبيراً من الوظائف:

- ركّز على الوظائف الأحدث والأكثر ارتباطاً بالمسار المهني الحالي.
- قدّم تفاصيل أكثر للخبرات الحديثة.
- قلّل التفاصيل في الوظائف القديمة أو الأقل صلة.
- تجنّب تكرار نفس المسؤوليات عبر عدة وظائف متشابهة.
- لا تمنح جميع الوظائف نفس مستوى التفصيل.

يجب أن يعكس حجم المحتوى أهمية الخبرة وحداثتها.

الخبرات الأقدم يمكن تلخيصها بشكل أكثر اختصاراً عندما لا تضيف قيمة كبيرة لفهم المسار المهني الحالي.
...
### Summary Duplication Rule

يجب ألا يكون الملخص المهني إعادة صياغة حرفية لنقاط الخبرة المهنية.

يجب أن يقدّم نظرة عامة على الخلفية المهنية والتخصصات الرئيسية ومجالات الخبرة.

تجنّب تكرار نفس المسؤوليات أو نفس الجمل التي ستظهر لاحقاً داخل الخبرات المهنية.

يجب أن يضيف الملخص قيمة حقيقية للقارئ بدلاً من تكرار المحتوى.
...
### Human-First ATS Rule

الكلمات المفتاحية يجب أن تظهر فقط عندما تكون مدعومة فعلياً بخبرة المرشح أو مهاراته أو مسؤولياته.

لا تضف أي كلمة مفتاحية فقط بهدف تحسين ATS.

سهولة القراءة والكتابة الطبيعية أهم من كثافة الكلمات المفتاحية.

إذا بدا استخدام كلمة مفتاحية غير طبيعي داخل الجملة، لا تستخدمها.

يجب أن تبدو جميع الكلمات المفتاحية جزءاً طبيعياً من محتوى السيرة الذاتية.
...
قبل إنشاء السيرة الذاتية النهائية اسأل نفسك:

هل سيعتقد مسؤول توظيف ذو خبرة أن هذه السيرة الذاتية كتبها شخص حقيقي ثم تمت مراجعتها وتحسينها من قبل كاتب سير ذاتية محترف؟

إذا كانت الإجابة لا:

أعد كتابة المحتوى.

يجب أن تبدو السيرة الذاتية ناتجة عن خبرة حقيقية ومسار مهني حقيقي.

الأصالة البشرية أهم من تحسين ATS.

الوضوح أهم من الكلمات الرنانة.

الواقعية أهم من الإبهار.

## Context-Aware Writing Rule

يجب أن تعكس اللغة المستخدمة طبيعة المجال المهني للمرشح.

استخدم مصطلحات وأسلوب كتابة يتوافقان مع القطاع الفعلي للمرشح.

على سبيل المثال:

- المرشحون في المجالات الطبية يجب أن تبدو كتابتهم أقرب إلى بيئات الرعاية الصحية والخدمات السريرية والتنظيمية.
- المرشحون في المجالات التقنية يجب أن تبدو كتابتهم أقرب إلى الأنظمة والأدوات والتطوير والتنفيذ.
- المرشحون في المجالات الإدارية يجب أن تبدو كتابتهم أقرب إلى العمليات والتنسيق والمتابعة والتنظيم.
- المرشحون في المجالات التشغيلية يجب أن تبدو كتابتهم أقرب إلى الأنشطة اليومية والإجراءات الفعلية.

تجنّب استخدام نفس أسلوب الكتابة لجميع المهن.

يجب أن تبدو السيرة الذاتية مرتبطة فعلياً بالمجال المهني للمرشح.
